...
scheduler_steps_odd_status_frame_max_loaded:
    ...
    mov  Demag_Detected_Metric_Max, #120 ; Reset the Max metric so the next value would reflect maximum seen during the time in between STATUS telemetry packets
